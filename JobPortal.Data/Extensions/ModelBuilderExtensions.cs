...
namespace JobPortal.Data.Extensions
{
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            {
                Id = adminId,
                UserName = "admin@techgarlic.com",
                NormalizedUserName = "ADMIN@TECHGARLIC.COM",
                Email = "admin@techgarlic.com",
                NormalizedEmail = "ADMIN@TECHGARLIC.COM",
                EmailConfirmed = true,
            ...
            modelBuilder.Entity<Province>().HasData(
               new Province() { Id = 1, Name = "Dhaka", Slug = "dhaka", CategoryId = 4 },
               new Province() { Id = 2, Name = "Chittagong", Slug = "chittagong", CategoryId = 4 },
               new Province() { Id = 3, Name = "Syhlet", Slug = "sylhet", CategoryId = 4 },
               new Province() { Id = 4, Name = "Barisal", Slug = "barisal", CategoryId = 4 },
               new Province() { Id = 5, Name = "Others", Slug = "others", CategoryId = 4 }
            );

            modelBuilder.Entity<Country>().HasData(
               new Country() { Id = 1, Name = "Bangladesh", Flag = "Bangladesh.png" },
